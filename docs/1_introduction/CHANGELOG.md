...
Check the [Migration Guide](https://developer.magiclane.com/docs/flutter/category/migration-guide) for complete steps required for upgrading to a new version.
