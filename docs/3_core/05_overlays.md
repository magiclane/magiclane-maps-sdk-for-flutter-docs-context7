...
Overlays cannot be used in offline mode, even if the corresponding region has been downloaded locally.
...
<table>
  ...
  <tbody>
    <tr>
      <td>categoryId</td>
      <td>Gets the OverlayItem's category ID. May be 0 if the item does not belong to a specfic category.</td>
      <td>int</td>
    </tr>
    <tr>
      <td>coordinates</td>
    ...
    <tr>
      ...
      <td>Checks if the OverlayItem has preview extended data (dynamic data).</td>
      <td>bool</td>
    </tr>
    <tr>
      <td>img</td>
