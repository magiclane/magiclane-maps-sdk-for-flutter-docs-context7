...
|------------------------ | --- | ----------- | --------------------- | -------------
| acquisitionTime         | ✅  | ✅          | always                | The acquisition time of data. When retrieved from a log data source, this represents the timestamp at which the data was originally acquired.
| satelliteTime           | ✅  | ✅          | always                | The satellite time 
