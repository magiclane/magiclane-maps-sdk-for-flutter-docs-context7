...
- ``List<ContentStoreItem>`` that contains the items retrieved from the content store, such as map styles in this case. If the error code is not ``GemError.success``, this list will be empty.
