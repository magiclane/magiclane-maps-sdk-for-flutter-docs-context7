...
When presenting the live camera feed, a video recording session must be active on the `DataSource`. See the [Video Recording guide](/guides/positioning/recorder#record-video) for more information on starting a video recording session.
